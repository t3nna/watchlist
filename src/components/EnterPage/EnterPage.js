            ...
            <nav className={'navbar-enter'}>
                ...
                <div className="navbar-enter-container">
                    <div className="svg-icon">
                        <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="90px"
                             height="90px">
                            <path
                    ...
                    <div className="svg-icon">
                        <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="192px"
                             height="192px">
                            <path
