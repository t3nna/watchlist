...
import background2 from '../../images/changing/film2.png'
import background3 from '../../images/changing/film3.png'
        ...
        <div className={'enter-page-image-slide'}>
            ...
            <nav className={'navbar-enter'}>
                <div className="navbar-enter-title-container">
                    <h1>IVAN MELNYK.{currentImage}</h1>
                </div>
                <div className="navbar-enter-container">
                    <div className="svg-icon">
                        <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="90px"
                             height="90px">
                            <path
                    ...
                    <div className="svg-icon">
                        <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="192px"
                             height="192px">
                            <path
